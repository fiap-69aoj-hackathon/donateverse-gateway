package com.donateverse.gateway.service;

import com.donateverse.gateway.dto.UserResponse;
...
public class UserService {
    ...
    public UserResponse findUser(final String email, final String password) {
        List<ServiceInstance> instances = discoveryClient.getInstances("donateverse-USER");
